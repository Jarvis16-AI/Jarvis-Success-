...
export const getUpdateConversationTitleUrl = (id: number,) => {




  return `/api/conversations/${id}/title`
}

/**
 * @summary Update conversation title
 */
export const updateConversationTitle = async (id: number,
    conversationTitleUpdate: ConversationTitleUpdate, options?: RequestInit): Promise<Conversation> => {

  return customFetch<Conversation>(getUpdateConversationTitleUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateConversationTitleMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateConversationTitle>>, TError,{id: number;data: BodyType<ConversationTitleUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateConversationTitle>>, TError,{id: number;data: BodyType<ConversationTitleUpdate>}, TContext> => {

const mutationKey = ['updateConversationTitle'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateConversationTitle>>, {id: number;data: BodyType<ConversationTitleUpdate>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateConversationTitle(id,data,requestOptions)
        }
 ...
 * @summary Update conversation title
 */
export const useUpdateConversationTitle = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateConversationTitle>>, TError,{id: number;data: BodyType<ConversationTitleUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateConversationTitle>>,
        TError,
        {id: number;data: BodyType<ConversationTitleUpdate>},
        TContext
      > => {
      return useMutation(getUpdateConversationTitleMutationOptions(options));
    }
